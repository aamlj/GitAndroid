package com.example.aamlj_000.flickr_searches_app;
...
public class MainActivity extends ListActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        // get values of the EditTexts
        queryEditText = (EditText) findViewById(R.id.queryEditText);
        tagEditText = (EditText) findViewById(R.id.tagEditText);

        // get the SharedPreferences containing saved searches
        savedSearches = getSharedPreferences(SEARCHES, MODE_PRIVATE);

        //saved tags in an ArrayList then sort them
        ...
        // register listener to save a search
        ImageButton saveButton =
                (ImageButton) findViewById(R.id.saveButton);
        saveButton.setOnClickListener(saveButtonListener);

        // register listener that searches Fickr when user touches a tag
    ...
    OnItemClickListener itemClickListener = new OnItemClickListener()
    {
                                ...
                                int position, long id)
        {
            ...
            String urlString = getString(R.string.searchURL) +//change to flicker,com
            ...
            startActivity(webIntent); // view results
        }
    };
